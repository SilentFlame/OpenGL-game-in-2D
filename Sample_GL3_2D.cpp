...
// Matrices.model = glm::mat4(1.0f);
 ...
 /* glm::mat4 translateTriangle = glm::translate (glm::vec3(2.0f, 2.5f, 0.0f)); // glTranslatef
...
void initGL (GLFWwindow* window, int width, int height)
{
	...
	createCannon();
  stand=createTriangle(0,0.25,0,-0.25,-0.25,0,0.25,-0.25,0,0.4,0.2,0);
  //if(shoot==true)
  b.radius=0.1;
  b.c_x=b.c_y=0;
